...
export const metadata = {
  title: 'Info - Pixel Blade Guide',
  description: 'Browse all info guides for Pixel Blade',
}

export default async function InfoPage() {
  const contentDir = path.join(process.cwd(), 'src', 'content', 'info')
  ...
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-5xl font-bold text-white mb-4">Info</h1>
      <p className="text-xl text-gray-300 mb-12">
        Browse all info guides for Pixel Blade
      </p>
