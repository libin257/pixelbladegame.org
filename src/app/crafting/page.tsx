      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-5xl font-bold text-white mb-4">
            Winter Burrow Crafting Recipes
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Find what you can craft with the materials you have. Select your available resources
            and instantly see all craftable items.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-yellow-300 mb-3">⚠️ Crafting Tips</h3>
            <ul className="space-y-2 text-sm text-gray-300">
        ...
        {/* Related Links */}
        <div className="bg-gradient-to-br from-[#1C162D] to-[#0D0A16] rounded-lg p-8 border border-gray-700 text-center">
          <h3 className="text-xl font-semibold text-white mb-4">Related Guides</h3>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/resources/granite/"
