...
export const metadata = {
  title: 'Tier List - Pixel Blade Guide',
  description: 'Browse all tier list guides for Pixel Blade',
}

export default async function TierListPage() {
  const contentDir = path.join(process.cwd(), 'src', 'content', 'tier-list')
  ...
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-5xl font-bold text-white mb-4">Tier List</h1>
      <p className="text-xl text-gray-300 mb-12">
        Browse all tier list guides for Pixel Blade
      </p>
