...
export default function WarmthToolPage() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-5xl font-bold text-white mb-4">
            Winter Burrow Warmth Calculator
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Plan your clothing combinations and calculate exactly how long you can survive in different temperature zones.
            Select your gear and see real-time survival time estimates.
          </p>
        </header>
        ...
        {/* Items Grid */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6">Select Your Clothing</h2>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
          <h2 className="text-2xl font-bold text-white mb-6">Warmth Duration Matrix</h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-300 mb-3">💡 Pro Tips</h3>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-yellow-300 mb-3">⚠️ Safety Reminders</h3>
            <ul className="space-y-2 text-sm text-gray-300">
        ...
        {/* Related Links */}
        <div className="mt-12 bg-gradient-to-br from-[#1C162D] to-[#0D0A16] rounded-lg p-8 border border-gray-700 text-center">
          <h3 className="text-xl font-semibold text-white mb-4">Want to Learn More?</h3>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/survival/warmth/"
              className="bg-[#F4B860] hover:bg-[#D99B3C] text-black font-semibold py-2 px-6 rounded-lg transition-colors"
            >
              Warmth System Guide
            </Link>
            <Link
              href="/guides/beginner/"
              className="bg-white/90 hover:bg-white text-[#1E3A34] font-semibold py-2 px-6 rounded-lg transition-colors"
            >
              Beginner Guide
            </Link>
            <Link
              href="/crafting/"
              className="border border-gray-600 hover:border-[#F4B860] text-gray-200 hover:text-white font-medium py-2 px-6 rounded-lg transition-colors"
            >
              Crafting Recipes
            </Link>
          </div>
